...
def main(argv):
    ...
    configfilename='config'   # configuration file
    starfilename='star'       # star catalog
    galfilename='gal'         # galaxy catalog
    outfilename='output.fits'
    ...
    Optpsfbeta = 3                    
    Optpsftrunc = 2.*Optpsfsize                   # arcsec 
